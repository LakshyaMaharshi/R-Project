...
demo, demo_meta = pyreadstat.read_xport(os.path.join(data_dir, 'DEMO_H.xpt'), encoding='latin1')
rxq, rxq_meta   = pyreadstat.read_xport(os.path.join(data_dir, 'RXQ_RX_H.xpt'), encoding='latin1')
cfq, cfq_meta   = pyreadstat.read_xport(os.path.join(data_dir, 'CFQ_H.xpt'), encoding='latin1')
