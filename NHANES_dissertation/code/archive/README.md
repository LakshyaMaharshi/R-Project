...
| `03_merge_mortality.py` | Parses the NHANES linked-mortality `.dat` and merges it on | The mortality strand was dropped. The dissertation is entirely cross-sectional and uses no mortality outcome. `data/2013-2014/NHANES_2013_2014_MORT_2019_PUBLIC.dat` is retained only for completeness. |
