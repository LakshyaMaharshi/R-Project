...
The comparison holds up. On the same participants, comorbidity adjustment moved burden by less than a tenth of a point under Boustani and by almost nothing under IACB, while cutting the medication-count estimate by 39% and 34% respectively. The attenuation is similar under both scales, and count stays just inside the conventional threshold in each (p=0.046 and p=0.044). What the comorbidities absorb is part of what medication count was carrying, not what burden was carrying, consistent with count acting partly as a marker of how many chronic conditions a person has and with burden measuring something those variables do not capture.
